local library = loadstring(game:HttpGet('https://raw.githubusercontent.com/dgwowxyz/lil-signalll/refs/heads/main/UI.lua'))()


local window = library.new('tompearl.cc', 'leadmarker')
...
-- // Sections \\ --
local section = tab.new_section('fuh')
local section1 = tab.new_section('mods')
